...
class Movimento(models.Model):
    ...
    imponibile_unitario = models.DecimalField(max_digits=10, decimal_places=2, default=0.00)
    prezzo_unitario = models.DecimalField(max_digits=10, decimal_places=2, editable=False, default=0.00)
    iva = models.DecimalField(choices=Iva.getChoices(), max_digits=5, decimal_places=2)
    prezzo_finale = models.DecimalField(max_digits=10, decimal_places=2, editable=False, default=0.00)
